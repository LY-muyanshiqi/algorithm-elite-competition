...
% K is the total number of array elements. For ease of computation decision K 
...
for i = 1 : N
    ...
    % possible values. V is the number of decision variable. A random      V 
    ...
    % vlaue of the objective function concatenated at the end. The elementsV + 1K 
    % V + 1 to K has the objective function valued.                        evaluate_objective 
